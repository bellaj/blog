...
<a class="skip-link screen-reader-text" href="#page"><?php _e( 'Skip to content', 'colordive' ); ?></a>
...
<div class="page-wrapper">
		...
		<div class="header-inner">
			...
			<?php if ( has_nav_menu('header') ): ?>
				<div id="wrap-nav-header" class="header-nav wrap-nav">
					<?php \Colordive\Nav::nav_menu(array('theme_location'=>'header','menu_id' => 'nav-header','fallback_cb'=> false)); ?>
				</div>
			<?php endif; ?>
			
			<?php if ( has_nav_menu('mobile') ): ?>
				<div id="wrap-nav-mobile" class="header-nav wrap-nav">
					<?php \Colordive\Nav::nav_menu(array('theme_location'=>'mobile','menu_id' => 'nav-mobile','fallback_cb'=> false)); ?>
				</div>
			<?php endif; ?>
	...
	<div class="main" id="page">
		...
		<?php if ( is_home() && !is_paged() ): ?>
			<?php get_template_part('inc/introduction'); ?>
		<?php endif; ?>
